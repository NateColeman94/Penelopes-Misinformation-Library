window.PENELOPE_COLLECTIONS = {
  ...
  "comics-graphic": {
    ...
    "description": "Capes, crossovers, memoirs, longboxes, secret identities, and cities with inadequate skylight policies.",
    "keys": [
      "batman year one",
  ...
  "dc-comics": {
    "name": "DC Comics",
    "description": "Newly cataloged illustrated misunderstandings.",
    "keys": [
      "batman year one",
      "the dark knight returns",
      "batman the long halloween",
  ...
  "recently-shelved-comics": {
    "name": "Recently Shelved — Comics & Graphic Novels",
    "description": "Newly cataloged graphic novels, comic series, creators, and heroes.",
    "keys": [
      "batman year one",
      "the dark knight returns",
      "batman the long halloween",
